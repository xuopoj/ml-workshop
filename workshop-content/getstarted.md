...
| 服务 | 地址 |
|------|------|
| VSCode (浏览器) | `http://100.102.191.233:28000/user/superuser/vscode/?folder=/home/ma-user/work` |
| JupyterLab | `http://100.102.191.233:28000/user/superuser/lab` |
| JupyterHub 控制面板 | `http://100.102.191.233:28000/hub/home` |
...
```
Host: 100.102.191.233
Port: 22223
User: ma-user
Password: <run passwd to set>
```
